...
def registration_page():
    ...
    with st.form("reg_form"):
        ...
        classes = ([f"10A{i}" for i in range(1, 10)] + 
...
def main_app():
    ...
    if user.get('role') == "student":
        ...
        with t4:
            thac_mac = st.text_area("Nhập thắc mắc hoặc phản ánh:")
    ...
    # --- GIAO DIỆN ADMIN BÁO ĂN ---
        ...
        if len(ds_an) > 0:
            ...
            st.info("Chưa có dữ liệu báo ăn mới nào.")
